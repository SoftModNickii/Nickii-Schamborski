...
- [ ] **Funke 2** (2026)
      Ablage: `_inbox/funke-2-2026/`

- [ ] **The Communicator** (2026)
      Ablage: `_inbox/the-communicator-2026/`
...
- [ ] **Lecture: The Politics of AI Aesthetics** (2025)
      Ablage: `_inbox/saic-lecture-2025/`

- [ ] **Voltaje Festival** (2025)
      Ablage: `_inbox/voltaje-festival-2025/`

- [ ] **Volunteer, CAA 114th Annual Conference** (2025)
      Ablage: `_inbox/caa-114th-annual-conference-volunteer-2025/`

- [ ] **DAAD Graduate Scholarship** (2025)
      Ablage: `_inbox/daad-graduate-2025/`

- [ ] **Colomboscope Volunteer** (2024)
      Ablage: `_inbox/colomboscope-2024/`

- [ ] **Coming Home: The End of Colonial Phantasms** (2023)
      Ablage: `_inbox/coming-home-2023/`

- [ ] **Workshop: How to Deal with Colonial Memorials** (2023)
      Ablage: `_inbox/wolfsburg-workshop-2023/`

- [ ] **Lecture: How to Exhibit in a Federal Art Hall** (2023)
      Ablage: `_inbox/hbk-lecture-exhibition-2023/`

- [ ] **Workshop: How to Revolutionize Art School** (2023)
      Ablage: `_inbox/hbk-workshop-discrimination-2023/`
...
- [ ] **Workshop Series at ZKM** (2021)
      Ablage: `_inbox/zkm-workshops-2021/`
...
- [ ] **Braunschweig International Film Festival** (2019)
      Ablage: `_inbox/biff-braunschweig-2019/`
...
- [ ] **Meisterschüler of Prof. Candice Breitz** (2021/2022)
      Ablage: `_inbox/hbk-meisterschueler-2021-2022/`
...
- `assets/images/Instrument der öffentlichen Kritik/` (5 Dateien)
